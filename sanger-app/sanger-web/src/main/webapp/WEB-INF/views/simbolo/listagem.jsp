    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <a class="btn btn-large btn-block btn-primary" href="<c:url value='/simbolo/novo' />" >Cadastrar Símbolo</a>
                ...
                <c:choose>
                    <c:when test="${ not empty lista}">
                        <table id="tbl_sanger">
                            ...
                            <tbody>
                                <c:forEach items="${lista}" var="simbolo" >
                                    <tr>
                                        <td><a href="<c:url value='/simbolo/${simbolo.id}' />">${simbolo.sigla}</a></td>
                                        <td><a href="<c:url value='/simbolo/${simbolo.id}' />">${simbolo.descricao}</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
