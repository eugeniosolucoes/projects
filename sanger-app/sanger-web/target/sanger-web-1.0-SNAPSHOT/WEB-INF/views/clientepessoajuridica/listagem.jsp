    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <a class="btn btn-large btn-block btn-primary" href="<c:url value='/clientepessoajuridica/novo' />" >Cadastrar Cliente Pessoa Jurídica</a>
                ...
                <c:choose>
                    <c:when test="${ not empty lista}">
                        <table id="tbl_sanger">
                            ...
                            <tbody>
                                <c:forEach items="${lista}" var="clientepessoajuridica" >
                                    <tr>
                                        <td><a href="<c:url value='/clientepessoajuridica/${clientepessoajuridica.id}' />">${clientepessoajuridica.cnpj}</a></td>
                                        <td><a href="<c:url value='/clientepessoajuridica/${clientepessoajuridica.id}' />">${clientepessoajuridica.nome}</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
