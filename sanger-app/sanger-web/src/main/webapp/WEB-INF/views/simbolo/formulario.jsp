        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <form>
                    <div id="tabs">
                        <ul>
                            <li><a href="#tabs-1">Símbolo</a></li>
                        </ul>
                        <div id="tabs-1">  
                            <input type="hidden" name="id" value="${simbolo.id}" /> 
                            <input class="span1" type="text" name="sigla"
                                   placeholder="Sigla" value="${simbolo.sigla}" /> 
                            <input class="span2" type="text"
                                   name="descricao" placeholder="Descrição"
                                   value="${simbolo.descricao}"/> 
                            <div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#btn-salvar").click(function() {
                    document.forms[0].action = '<c:url value="/simbolo/salvar" />';
