                                    ...
                                    <tbody>
                                        ...
                                        foreach ($lancamentos as $lancamento) {
                                            ...
                                            <tr class="item">
                                                ...
                                                <td><a class="link_descricao"  href="<?php echo CONTEXT_PATH . "view/lancamento/form.php?comando=retornar&id={$lancamento->get_id()}&mes={$lancamento->get_mes()}&ano={$lancamento->get_ano()}"; ?>"><?php echo "{$lancamento->get_descricao()} {$lancamento->get_parcela_fmt()}"; ?></a>
