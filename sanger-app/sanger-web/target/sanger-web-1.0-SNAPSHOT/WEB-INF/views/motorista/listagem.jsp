    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <a class="btn btn-large btn-block btn-primary" href="<c:url value='/motorista/novo' />" >Cadastrar Motorista</a>
                ...
                <c:choose>
                    <c:when test="${ not empty lista}">
                        <table id="tbl_sanger">
                            ...
                            <tbody>
                                <c:forEach items="${lista}" var="motorista" >
                                    <tr>
                                        <td><a href="<c:url value='/motorista/${motorista.id}' />">${motorista.cpf}</a></td>
                                        <td><a href="<c:url value='/motorista/${motorista.id}' />">${motorista.nome}</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
