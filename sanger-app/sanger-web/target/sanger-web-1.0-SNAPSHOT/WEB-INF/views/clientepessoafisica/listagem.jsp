    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <a class="btn btn-large btn-block btn-primary" href="<c:url value='/clientepessoafisica/novo' />" >Cadastrar Cliente Pessoa Física</a>
                ...
                <c:choose>
                    <c:when test="${ not empty lista}">
                        <table id="tbl_sanger">
                            ...
                            <tbody>
                                <c:forEach items="${lista}" var="clientepessoafisica" >
                                    <tr>
                                        <td><a href="<c:url value='/clientepessoafisica/${clientepessoafisica.id}' />">${clientepessoafisica.cpf}</a></td>
                                        <td><a href="<c:url value='/clientepessoafisica/${clientepessoafisica.id}' />">${clientepessoafisica.nome}</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
