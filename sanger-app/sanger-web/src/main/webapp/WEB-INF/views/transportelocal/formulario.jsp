        ...
        <script>
            ...
            <c:if test="${not empty transportelocal.id}">
                    $("#btn-excluir").click(function() {
                        excluir('o transportelocal ${transportelocal.descricao}', '<c:url value="/transportelocal/excluir/${transportelocal.id}" />');
