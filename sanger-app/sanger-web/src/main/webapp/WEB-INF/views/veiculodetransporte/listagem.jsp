    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <a class="btn btn-large btn-block btn-primary" href="<c:url value='/veiculodetransporte/novo' />" >Cadastrar Veículo de Transporte</a>
                ...
                <c:choose>
                    <c:when test="${ not empty lista}">
                        <table id="tbl_sanger">
                            ...
                            <tbody>
                                <c:forEach items="${lista}" var="veiculodetransporte" >
                                    <tr>
                                        <td><a href="<c:url value='/veiculodetransporte/${veiculodetransporte.id}' />">${veiculodetransporte.placa}</a></td>
                                        <td><a href="<c:url value='/veiculodetransporte/${veiculodetransporte.id}' />">${veiculodetransporte.marca} / ${veiculodetransporte.modelo}</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
